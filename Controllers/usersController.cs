...
namespace kholase.Controllers
{
    public class usersController : Controller
    {
        private string[] Mobiles;
        private readonly kholaseContext _context;

        public usersController(kholaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("id_user,name,u_name,u_pass,admin")] user user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("id_user,name,u_name,u_pass")] user user)
        {
            if (id != user.id_user)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'kholaseContext.user'  is null.");
            }
            var user = await _context.user.FindAsync(id);
            if (user != null)
            {
